...
describe('UbsTable', () => {
  it('textando renderizacao: renders tr for each item in props.ubsList', () => {
    const ubsList = [
      new Ubs({
        ...
        dsc_equipamentos: 'Desempenho muito acima da média',
      ...
      new Ubs({
        ...
        cod_munic: 411885,
        cod_cnes: 6811299,
        nom_estab: 'UNIDADE DE ATENCAO PRIMARIA SAUDE DA FAMILIAA',
        dsc_endereco: 'RUA GUILHERME BRUXEL',
        dsc_bairro: 'CENTRO',
        dsc_cidade: 'Perobal',
        dsc_telefone: '3337411423',
        dsc_estrut_fisic_ambiencia: 'Desempenho acima da média',
        dsc_adap_defic_fisic_idosos:
					'Desempenho mediano ou um pouco abaixo da média',
        dsc_equipamentos: 'Desempenho muito acima da média',
    ...
    expect(wrapper.findAll('tr')).toHaveLength(ubsList.length)
  })
})
...
describe('Pagination', () => {
  ...
  it('textando atributos: o valor inicial de actualPage deve ser 0', () => {
    const wrapper = shallowMount(Pagination, {
      propsData: { list: ubsList, perPage: 2 }
    })
